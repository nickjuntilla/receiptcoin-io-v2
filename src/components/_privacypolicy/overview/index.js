  ...
  render() {
    return (
      <Container>
        ...
        <p>ReceiptCoin built the Receiptchain app as a commerical app. This SERVICE is provided by ReceiptCoin and is intended
          for use as is.</p>
        ...
        <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions,
          which is accessible at Receiptchain, unless otherwise defined in this Privacy Policy.</p>

        <p><strong>Information Collection and Use</strong></p>
        <p>For a better experience while using our Service, we may require you to provide us with certain
          personally identifiable information, including but not limited to email and pictures.
